  ...
  if (bestaetigen) {
    return (
      <Rahmen>
        ...
        {/* Was hier steht, hängt daran, was gleich wirklich passiert. Ein
            „wir haben dir eine Mail geschickt" an jemanden, der keine bekommt,
            ist der teuerste Satz der ganzen App: Er schickt jemanden ins
            Postfach, lässt ihn suchen, und am Ende zweifelt er an sich und
            nicht an uns. */}
        {mailAn ? (
          <p className="mb-6 text-sm leading-relaxed text-muted text-pretty">
            ...
            die Adresse, sobald du magst — danach können wir dir ein neues Passwort schicken, falls
            du es vergisst.
          </p>
        ) : (
          <p className="mb-6 text-sm leading-relaxed text-muted text-pretty">
            Du kannst sofort loslegen. Mails verschickt die App noch nicht — merk dir das Passwort
            deshalb gut, zurücksetzen geht erst, wenn sie es kann.
          </p>
        )}
        <button
          type="button"
