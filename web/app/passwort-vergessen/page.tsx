      ...
      {geschickt ? (
        <>
          <p className="mb-6 text-sm leading-relaxed text-muted text-pretty">
            Wenn es zu <strong className="text-fg">{email}</strong> ein Konto gibt, ist
            die Mail unterwegs. Der Link darin gilt eine Stunde.
          </p>
          <Link href="/anmelden" className="text-sm font-semibold text-primary underline underline-offset-2">
            Zurück zum Anmelden
          </Link>
        </>
      ) : (
